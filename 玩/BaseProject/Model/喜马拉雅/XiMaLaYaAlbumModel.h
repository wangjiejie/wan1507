...
@class XiMaLaYaAlbumTracksModel,XiMaLaYaAlbumAlbumModel,XiMaLaYaAlbumTracksListModel;
@interface XiMaLaYaAlbumModel : BaseModel

@property (nonatomic, strong) XiMaLaYaAlbumTracksModel *tracks;

@property (nonatomic, strong) XiMaLaYaAlbumAlbumModel *album;
...
@end
@interface XiMaLaYaAlbumAlbumModel : NSObject
...
@interface XiMaLaYaAlbumTracksModel : NSObject

@property (nonatomic, assign) NSInteger maxPageId;

@property (nonatomic, strong) NSArray<XiMaLaYaAlbumTracksListModel *> *list;
...
@interface XiMaLaYaAlbumTracksListModel : NSObject
