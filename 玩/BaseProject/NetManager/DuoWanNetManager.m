...
{
    return [self GET:kHeroDetailPath parameters:@{kV, kOSType, @"hero": enName} completionHandler:^(id responseObj, NSError *error) {
        completionHandle([DuoWanHeroDetailModel objectArrayWithKeyValuesArray:responseObj], error);
    }];
}
