...
@class DuoWanHeroDetail_QModel,DuoWanHeroDetailLikeModel,DuoWanHeroDetailHateModel;

@interface DuoWanHeroDetailModel : BaseModel

@property (nonatomic, copy) NSString *ratingAttack;

@property (nonatomic, strong) DuoWanHeroDetail_QModel *Braum_W;

@property (nonatomic, copy) NSString *ID;

@property (nonatomic, copy) NSString *healthLevel;

@property (nonatomic, strong) DuoWanHeroDetail_QModel *Braum_Q;
...
@property (nonatomic, strong) NSArray<DuoWanHeroDetailHateModel *> *hate;

@property (nonatomic, strong) DuoWanHeroDetail_QModel *Braum_E;
...
@property (nonatomic, strong) NSArray<DuoWanHeroDetailLikeModel *> *like;
...
@property (nonatomic, strong) DuoWanHeroDetail_QModel *Braum_B;
...
@property (nonatomic, strong) DuoWanHeroDetail_QModel *Braum_R;
...
@interface DuoWanHeroDetail_QModel : NSObject
...
@interface DuoWanHeroDetailLikeModel : NSObject
...
@interface DuoWanHeroDetailHateModel : NSObject
