...
#define kIconSpace  (kWindowW - 50 * 5)/6
- (TuWanImageView *)iconView1 {
    if(_iconView1 == nil) {
        _iconView1 = [[TuWanImageView alloc] init];
...
- (TuWanImageView *)iconView2 {
    if(_iconView2 == nil) {
        _iconView2 = [[TuWanImageView alloc] init];
        ...
        [_iconView2 mas_makeConstraints:^(MASConstraintMaker *make) {
            ...
            make.size.mas_equalTo(self.iconView1);
        }];
    }
    return _iconView2;
}

- (TuWanImageView *)iconView3 {
    if(_iconView3 == nil) {
        _iconView3 = [[TuWanImageView alloc] init];
...
- (TuWanImageView *)iconView4 {
    if(_iconView4 == nil) {
        _iconView4 = [[TuWanImageView alloc] init];
...
- (TuWanImageView *)iconView5 {
    if(_iconView5 == nil) {
        _iconView5 = [[TuWanImageView alloc] init];
